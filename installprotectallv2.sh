...
BASE_URL="https://raw.githubusercontent.com/liaacans/installers/refs/heads/main/v2"
...
install_all() {
    show_header
    echo "⏳ Memulai instalasi semua Protect Panel (1-14)..."
    echo
...
main_menu() {
    while true; do
        ...
        case $choice in
            ...
            3)
                show_header
                echo "Terima kasih telah menggunakan Protect Andin Official!"
                echo "Tele:: @andinsukaapink"
                echo "Akun Telegram saya ada di atas🥰"
                echo "Goodbye! 👋"
                exit 0
                ;;
            *)
