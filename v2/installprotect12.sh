...
echo "🚀 Memasang proteksi Anti Mount Access..."
...
class MountController extends Controller
{
    ...
    private function checkAdminAccess()
    {
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: hanya Admin utama (ID 1) yang boleh akses Mount! © Created By Andin Official');
        }
    }
...
echo "✅ Proteksi Anti Mount Access berhasil dipasang!"
echo "📂 Lokasi file: $REMOTE_PATH"
echo "🗂️ Backup file lama: $BACKUP_PATH (jika sebelumnya ada)"
echo "🔒 Hanya Admin ID 1 yang bisa:"
echo "   • Melihat daftar mounts"
echo "   • Melihat detail mount"
echo "   • Membuat mount baru"
echo "   • Mengupdate mount"
echo "   • Menghapus mount"
echo "   • Menambahkan eggs ke mount"
echo "   • Menambahkan nodes ke mount"
echo "   • Menghapus egg dari mount"
echo "   • Menghapus node dari mount"
