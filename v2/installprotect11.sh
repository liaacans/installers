...
echo "🚀 Memasang proteksi Anti Database Host Access..."
...
class DatabaseController extends Controller
{
    ...
    private function checkAccess()
    {
        ...
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 Akses ditolak: hanya admin ID 1 yang dapat mengelola Database! © Created By Andin Official');
        }
    }
...
echo "✅ Proteksi Anti Database Host Access berhasil dipasang!"
echo "📂 Lokasi file: $REMOTE_PATH"
echo "🗂️ Backup file lama: $BACKUP_PATH (jika sebelumnya ada)"
echo "🔒 Hanya Admin ID 1 yang bisa:"
echo "   • Melihat daftar database hosts"
echo "   • Melihat detail database host"
echo "   • Membuat database host baru"
echo "   • Mengupdate database host"
echo "   • Menghapus database host"
echo "   • Melihat databases pada host"
